...
<body>
    <h1 align="center">Delete/Update Results</h1>
	...
	<br>  
	<c:url value="deleteResults.jsp" var="rdelete">
	...
	<a href="${rdelete}">
	<input type="button" name="delete" class="btn2" value="Delete">
	</a>
...
<div>
<a href="allResults.jsp" class="backb">All Results</a>
</div> 
...
<div>
<a href="adminHome.jsp" class="backb">Home</a>
</div> 
